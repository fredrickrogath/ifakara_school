...
export default {
    ...
    computed: {
        ...
        getCurrentTab() {
            return this.$store.getters["AccountantUploadModule/getTab"];
        },
    },
    watch: {
        //Add watchers...
    ...
    methods: {
        //Add methods...
        setTab(tab) {
            this.$store.dispatch("AccountantUploadModule/setTab", tab);
        },
        ...
        upload() {
            ...
            axios.post("/accountant/upload", formData).then((response) => {
