                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-13 mb-4">
                            ...
                            common set of options, API methods and styling to
                            display buttons on a page that will interact with a
                            DataTable. The core library provides the based
...
export default {
    mounted() {
        Inertia.on('pageLoaded', this.initializeScripts);
