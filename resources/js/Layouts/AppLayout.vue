<template>
    <div>
        ...
        <div class="min-h-screen shadow-xl bg-white">
            <nav class="border-b border-gray-100 dark:border-gray-700 sticky top-0 z-50 fixed-top bg-white">
        ...
        ">
                ...
                <Transition duration="550" name="fade-menu">
                    <div v-if="show" class="absolute w-full bg-white dark:bg-gray-900 z-10">
                        <div :class="{
                            ...
                            <div class="pt-4 pb-1 border-t border-gray-200">
                                <div class="flex items-center px-4">
                                    ...
                                    <div>
                                        <div class="font-medium text-base dark:text-gray-600 text-gray-800">
                                            {{ $page.props.user.name }}
                                        </div>
        ...
        ">
                                        ...
                                        <template v-for="team in $page.props.user
                                            .all_teams">
                                            <form @submit.prevent="
                                                switchToTeam(team)
                                                " :key="team.id">
